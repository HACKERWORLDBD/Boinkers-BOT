...
Register Here : [Boinkers](https://t.me/boinker_bot/boinkapp?startapp=boink980269339)

Join Our Channel:- https://t.me/HACKER_WORLD_BD
...
1. **Kloning repositori:**
   ```bash
   git clone https://github.com/HACKERWORLDBD/Boinkers-BOT.git
   ```
   ```bash
   cd Boinkers-BOT
   ```
